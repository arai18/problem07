...
<?php echo form_open("/admin/member_edit/{$member->id}"); ?>
    ...
    <?php echo form_dropdown('gender', [ $this->Member_model->gender_mail => '男', $this->Member_model->gender_femail => '女' ], set_value('gender', $member->gender)); ?><br />
